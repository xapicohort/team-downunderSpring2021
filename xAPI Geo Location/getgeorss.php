        ...
        foreach($jsonArray['incident'] as $entry)
            {
                ...
                $temp["resource-count"]=(string)$entry['@attributes']['resource-count'];
                $temp["incident-no"]=(string)$entry['@attributes']['incident-no'];
                $temp["lat"]=(string)$entry['@attributes']['latitude'];
                $temp["long"]=(string)$entry['@attributes']['longitude'];
                $temp["longdesc"]=(string)$entry['category1']. ' at '. (string)$entry['incident-location'] .' '. (string)$entry['municipality'] ." ". (string)$entry['name'] .'. Being managed by ' . $entry['agency']. "<br/>Resource Count:". $temp["resource-count"] .". <br/>Incident Number: " . $temp["incident-no"];
